...
//   patchQueryPrototype();
//   return relationPlugin;

//   /**
//    * Patches Query prototype to add `relationPlugin()` method.
//    */
//   function patchQueryPrototype() {
//     var Query = mongoose.Query,
//       _exec = Query.prototype.exec;

//     if (Query.prototype.relation != null) {
//       return;
//     }

//     /**
//      * Registers relation population on this query.
...
//      * @return {Query}
//      */
//     Query.prototype.relation = function(paths, options) {
//       if (this.model.schema.methods.relation == null) {
//         throw new Error("Plugin was not installed");
//       }

//       if (this._relation) {
//         throw new Error("relation was already invoked");
//       }

//       this._relation = { paths: paths, options: options };
//       return this;
//     };
...
//         defaultOptions = model.schema._defaultrelationOptions,
...
//             execute(model, docs, paths, options, defaultOptions, lean, function(
//               err,
//               docs
//             ) {
...
//    */
//   function relationPlugin(schema, defaultOptions) {
//     schema._defaultrelationOptions = defaultOptions = defaultOptions || {};
...
//      * @return {MongoosePromise}
//      */
//     schema.methods.relation = function(paths, options, cb) {
//       return relation(this.constructor, this, paths, options, cb);
//     };
...
//      * @return {MongoosePromise}
//      */
//     schema.statics.relation = function(docs, paths, options, cb) {
//       return relation(this, docs, paths, options, cb);
//     };

//     function relation(model, docs, paths, options, cb) {
...
//         execute(model, docs, paths, options, defaultOptions, false, function(
//           err,
//           docs
//         ) {
//           if (err) reject(err), cb(err);
...
//       if (model != null) {
//         populateOpts = extend({}, opts.options[path], {
//           path: path,
